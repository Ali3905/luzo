  ...
  return (
    <div className="px-[10px] sm:px-[120px] mt-[100px]">
      ...
      <div className="flex flex-wrap gap-[30px] cursor-pointer py-[20px]">
        <Link to='/salon/jcb' className={"w-[30%]"}>
        ...
        <Link to='/salon/tattva' className={"w-[30%]"}>
          <div className='flex flex-col gap-[20px]  relative rounded-xl overflow-hidden  '>
        ...
        <Link to='/salon/juice' className={"w-[30%]"}> 
        ...
        <Link to='/salon/harsha-rakesh' className={"w-[30%]"}>
          <div className='flex flex-col gap-[20px]  relative rounded-xl overflow-hidden  '>
        ...
        <Link to='/salon/the-first'  className={"w-[30%]"}>
          <div className='flex flex-col gap-[20px]  relative rounded-xl overflow-hidden  '>
        ...
        <Link to='/salon/bodycraft' className={"w-[30%]"}>
          <div className='flex flex-col gap-[20px]  relative rounded-xl overflow-hidden  '>
        ...
        <Link to='/salon/lookwell' className={"w-[30%]"}>
          <div className='flex flex-col gap-[20px]  relative rounded-xl overflow-hidden  '>
        ...
        <Link to='/salon/apple' className={"w-[30%]"}>
          <div className='flex flex-col gap-[20px]  relative rounded-xl overflow-hidden  '>
        ...
        <Link to='/salon/tip-and-toe' className={"w-[30%]"}>
          <div className='flex flex-col gap-[20px]  relative rounded-xl overflow-hidden  '>
        ...
        <Link to='/salon/toni-and-guy' className={"w-[30%]"}>
          <div className='flex flex-col gap-[20px]  relative rounded-xl overflow-hidden  '>
        ...
        <Link to='/salon/femina-flaunt' className={"w-[30%]"}>
          <div className='flex flex-col gap-[20px]  relative rounded-xl overflow-hidden  '>
        ...
        <Link to='/salon/bblunt' className={"w-[30%]"}>
          <div className='flex flex-col gap-[20px]  relative rounded-xl overflow-hidden  '>
        ...
        <Link to='/salon/kprive' className={"w-[30%]"}>
          <div className='flex flex-col gap-[20px]  relative rounded-xl overflow-hidden  '>
        ...
        <Link to='/salon/fashiontv' className={"w-[30%]"}>
          <div className='flex flex-col gap-[20px]  relative rounded-xl overflow-hidden  '>
